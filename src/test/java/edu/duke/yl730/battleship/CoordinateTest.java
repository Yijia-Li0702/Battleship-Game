...
public class CoordinateTest {
  ...
  public void test_string_constructor_error_cases() {
    ...
    //assertThrows(IllegalArgumentException.class, () -> new Coordinate("Z8"));
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("8Z"));
    assertThrows(IllegalArgumentException.class, () -> new Coordinate("89"));
